      ...
      <nav className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-20 items-center">
          ...
          <div className="flex space-x-3">
            ...
            <Link
              to="/questionnaire"
              className="bg-gradient-to-r from-sky-500 to-sky-600 hover:from-sky-600 hover:to-sky-700 text-white px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 shadow-md hover:shadow-lg border-2 border-yellow-300 hover:border-yellow-400"
            >
              Adotar Pet
            </Link>
          </div>
